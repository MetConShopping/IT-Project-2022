...
export default class PromotionTableRow extends Component {
    ...
    deleteStudent() {
        axios.delete('http://localhost:8070/promotion/delete/' + this.props.obj._id)
            .then((res) => {
    ...
    render() {
        return (
            <tr>
                ...
                <td style={{ color: "darkgray" }}>{this.props.obj.quantity}</td>
                <td style={{ color: "darkgray" }}>{this.props.obj.description}</td>
                <td style={{ color: "darkgray" }}>{this.props.obj.discount_Rate}</td>
                <td style={{ color: "darkgray" }}>{this.props.obj.prior_price}</td>
                <td style={{ color: "darkgray" }}>{this.props.obj.present_price}</td>
