...
const Addpromotion = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8070/promotion/add', formData) //add promotion data
             .then(res => {
                console.log(res);
                setLoading(false);
    ...
    return (
        ...
        <div className="marketingImage"  style={{width:"100%"}}  ><br/><br/><br/>
            ...
            <div className="cmb-3"><br/>
                ...
                /><br/>
                <label for="quantity" className="form-label">Quantity <span class = "required">*</span></label>
                <input 
                    type="text"
