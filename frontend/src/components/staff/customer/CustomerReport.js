...
export default class CustomerReport extends Component {
  ...
  printDocument() {
    ...
    html2canvas(input).then((canvas) => {
      ...
      doc.setFontSize(28);
      doc.text(85, 10, "Customer");
      doc.setTextColor(0, 0, 255);
      doc.setFontSize(16);
      doc.text(10, 70, "Customer Management");
      ...
      const dateStr =
        "CustomerManagement_" + date[0] + date[1] + date[2] + date[3] + date[4];
              ...
              {this.state?.ReportData?.map((p, index) => {
                return (
                  <TableRow key={index}>
                    ...
                    <TableCell align="right">+94 {p.contactNo}</TableCell>
