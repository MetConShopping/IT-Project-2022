            ...
            <div className="our_solution_category">
              <div className="solution_cards_box">
                ...
                <div className="solution_card" style={{ opacity: "1" }}>
                  ...
                  <div className="solu_description">
                    <p>
                      <img src={"cusmanagement.jpg"} style={{ width: "150px", height: "150px" }} />
                    </p>
                    <Link to="/login"><button type="button" className="read_more_btn">Login</button></Link>
                  </div>
                </div>
              ...
              <div className="solution_cards_box sol_card_top_3">
                <div className="solution_card">
                  ...
                  <div className="solu_description">
                    <p>
                      <img src={"odrmng1.jpg"} style={{ width: "150px", height: "150px" }} />
                    </p>
                    <Link to="/login"><button type="button" className="read_more_btn">Login</button></Link>
                  </div>
                </div>
                <div className="solution_card">
                  ...
                  <div className="solu_description">
                    <p>
                      <img src={"IMG_6202.jpg"} style={{ width: "150px", height: "150px" }} />
                    </p>
                    <Link to="/login"><button type="button" className="read_more_btn">Login</button></Link>
                  </div>
                </div>
